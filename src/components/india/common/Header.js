        ...
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="items-center hidden space-x-8 md:flex">
            ...
            <Link href="/visa/step-one">
              <span className="inline-flex items-center px-6 py-2.5 text-sm font-medium bg-primary text-white rounded hover:bg-primary-dark transition-colors duration-300">
                Start Application
                <svg
